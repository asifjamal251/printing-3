                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    {{ html()->form('POST', route('admin.2fa.verify.post'))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open() }}

     

                                    <div class="form-group{{ $errors->has('one_time_password') ? ' has-error' : '' }}">
                                        {{ html()->label('One Time Password', 'one_time_password') }}
                                        {{ html()->text('one_time_password')->class('form-control')->placeholder('One Time Password') }}
                                        <small class="text-danger">{{ $errors->first('one_time_password') }}</small>
                                    </div>
                                    
                                    {{ html()->button('Verify Otp')->type('submit')->class('btn btn-success bg-gradient')->attribute('onclick = store(this)') }}
