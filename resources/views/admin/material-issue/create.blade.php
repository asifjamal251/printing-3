        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('department', App\Models\Department::orderBy('name', 'asc')->pluck('name', 'id'))->class('js-choice form-control')->placeholder('Select Department') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('material_issue_date') ? ' has-error' : '' }}">
                    ...
                    {{ html()->text('material_issue_date')->id('material_issue_date')->placeholder('Material Issue Date')->class('dateSelector form-control') }}
