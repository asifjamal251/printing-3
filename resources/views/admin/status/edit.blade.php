{!! html()->form('PUT', route('admin.'.request()->segment(2).'.update', $status->id))->attribute('files', true)->open() !!}
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    {{ html()->text('name', $status->name)->class('form-control')->placeholder('Name') }}
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group{{ $errors->has('background_colour') ? ' has-error' : '' }}">
                    ...
                    value="{{ old('background_colour', $status->background_colour??'#000000') }}"
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group{{ $errors->has('text_colour') ? ' has-error' : '' }}">
                    ...
                    name="text_colour" 
                    id="text_colour" 
                    value="{{ old('text_colour', $status->text_colour??'#ffffff') }}"
                    class="form-control" style="height:39px">
