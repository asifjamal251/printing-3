    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                @can('add_product')
                 <a id="create" data-url="{{route('admin.product.create')}}" data-title="Create Product" href="javascript:void(0);"  class="btn-sm btn btn-primary btn-label rounded-pill">
        ...
        <div class="row ">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('vendor') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('vendor', [])->id('vendors')->placeholder('Choose Vendor')->class('vendor form-control') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('bill_to') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('bill_to', [])->id('bill_to')->placeholder('Bill To')->class('firm form-control') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('ship_to') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('ship_to', [])->id('ship_to')->placeholder('Ship To')->class('firm form-control') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('mo_date') ? ' has-error' : '' }}">
                    ...
                    {{ html()->text('mo_date')->id('mo_date')->placeholder('MO Date')->class('dateSelector form-control') }}
                    ...
                    <div class="card-body">
                        <div class="product-row custom-row gap-3 stock-error d-flex justify-content-between flex-sm-wrape">
                            ...
                            <div class="w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.quantity") ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    {{ html()->text("kt_docs_repeater_advanced[$index][quantity]")->class('form-control ktquantity')->placeholder('Quantity') }}
                            ...
                            <div class="w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.item_per_packet") ? ' has-error' : '' }}">
                                ...
                                {{ html()->select("kt_docs_repeater_advanced[$index][item_per_packet]", [])->class('productAttribute form-control')->placeholder('Item/Packet') }}
                            ...
                            <div class="w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.weight_per_piece") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][weight_per_piece]")->class('form-control')->attribute('readonly')->placeholder('WT/PC/PKT') }}
                        ...
                        <div class="product-row custom-row gap-3 stock-error d-flex justify-content-between flex-sm-wrape">
                            <div class="m-0 w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.total_weight") ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    {{ html()->text("kt_docs_repeater_advanced[$index][total_weight]")->class('form-control')->attribute('readonly')->placeholder('Total WT') }}
                                    <span class="input-group-text unit">Unit</span>
                                </div>
                            ...
                            <div class="m-0 w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.rate") ? ' has-error' : '' }}">
                                ...
                                @can('rate_product')
                                <a  model-size="modal-xl" data-title="View Product Rate" data-url="{{route('admin.product.rate')}}" href="javascript:void(0);"  class="product-rate create float-end text-end text-decoration-underline ps-2" style="width:75px;">View Rate</a>
                                @endcan

                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    {{ html()->text("kt_docs_repeater_advanced[$index][rate]")->class('form-control ktrate')->placeholder('Rate') }}
                                </div>
                            ...
                            <div class="m-0 w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.gst") ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    {{ html()->text("kt_docs_repeater_advanced[$index][gst]")->class('form-control ktgst')->attribute('readonly')->placeholder('GST') }}
                                    <span class="input-group-text">%</span>
                                </div>
                            ...
                            <div class="m-0 w-75 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.amount") ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    {{ html()->text("kt_docs_repeater_advanced[$index][amount]")->class('productAttribute form-control')->attribute('readonly')->placeholder('Amount') }}
                                </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
    ...
    if ($('#firm').length > 0 || $('.firm').length > 0) {
        getFirm('.firm', false);
    }
