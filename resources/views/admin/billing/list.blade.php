...
<ul id="customContextMenu" class="p-0 dropdown-menu dropdown-menu dropdownmenu-secondary" style="min-width:200pxdisplay:none; position:absolute; z-index: 10000;">
    ...
    <li>
        <a class="dropdown-item" href="javascript:void(0)" id="contextRateCompleted"><i class="mdi mdi-check-all me-2"></i>Rate Completed</a>
    </li>
    ...
    $(document).ready(function(){
        var table2 = $('#datatable').DataTable({
            ...
            createdRow: function(row, data) {
                ...
                if (data.status_id === 6) $(row).addClass('bg-success-subtle');
            },
