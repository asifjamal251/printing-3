        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has("colour") ? ' has-error' : '' }}">
                    ...
                    {{ html()->text("colour")->class('form-control')->placeholder('Colour') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group{{ $errors->has("product_type") ? ' has-error' : '' }}">
                    {{ html()->label('Paper Quality', "product_type") }}  <span class="text-danger">*</span>
                    {{ html()->select("product_type", App\Models\ProductType::orderBy('name', 'asc')->where('type', 'Paper')->pluck('name', 'id'))->id('ItemTypeChange')->class('js-choice-search form-control')->placeholder('Paper Quality') }}
            ...
            <div class="col-md-3 col-sm-12">
                <div class="m-0 form-group{{ $errors->has('coating') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('coating', App\Models\CoatingType::orderBy('name', 'asc')->pluck('name', 'id'))
            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group{{ $errors->has('other_coating') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('other_coating', App\Models\OtherCoatingType::orderBy('name', 'asc')->pluck('name', 'id'))->class('form-control js-choice')->placeholder('Select Other Coating') }}
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('embossing') ? ' has-error' : '' }}">
                            ...
                            {{ html()->select('embossing', ['Yes' => 'Yes', 'No' => 'No'])
                            ->class('form-control js-choice')
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('back_print') ? ' has-error' : '' }}">
                            ...
                            {{ html()->select('back_print', ['Yes' => 'Yes', 'No' => 'No'])
                            ->class('form-control js-choice')
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="m-0 form-group{{ $errors->has('braille') ? ' has-error' : '' }}">
                            {{ html()->label('Braille', 'braille') }} <span class="text-danger">*</span>
                            {{ html()->select('braille', ['Yes' => 'Yes', 'No' => 'No'])
                            ->class('form-control js-choice')
                            ->placeholder('Select Braille') }}
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="m-0 form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            {{ html()->select('status', App\Models\Status::orderBy('name', 'asc')->whereIn('id', [15,14])->pluck('name', 'id'), 14)->class('form-control js-choice')->placeholder('Choose Status') }}
