    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <button type="button" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle open-cart" id="page-header-cart-dropdown">
                        <i class="bx bx-shopping-bag fs-22"></i>
                        <span class="position-absolute topbar-badge cartitem-count fs-10 translate-middle badge rounded-pill bg-info"> {{ count(session('cart', [])) }}</span>
                    </button>
                </div>
