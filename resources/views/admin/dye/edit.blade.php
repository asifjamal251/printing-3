...
{{ html()->form('Put', route('admin.' . request()->segment(2) . '.update', $die->id))->attribute('enctype', 'multipart/form-data')->id('store')->open() }}
        ...
        <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="m-0 form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                        ...
                        {{ html()->select('type', ['Mix' => 'Mix', 'Separate' => 'Separate'], $die->type)
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="m-0 form-group{{ $errors->has("dye_number") ? ' has-error' : '' }}">
                        ...
                        {{ html()->text("dye_number", $die->dye_number)->class('form-control')->placeholder('Dye Number') }}
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="m-0 form-group{{ $errors->has("sheet_size") ? ' has-error' : '' }}">
                        ...
                        {{ html()->text("sheet_size", $die->sheet_size)->class('form-control')->placeholder('Sheet Size') }}
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="m-0 form-group{{ $errors->has('dye_type') ? ' has-error' : '' }}">
                        ...
                        {{ html()->select('dye_type', ['Manual' => 'Manual', 'Automatic' => 'Automatic'], $die->dye_type)
                        ->class('form-control js-choice')
    ...
    <div class="report-repeater">
        <div id="kt_docs_repeater_advanced">
            ...
            <div data-repeater-list="kt_docs_repeater_advanced">
                ...
                @foreach(old('kt_docs_repeater_advanced', $die->items ?? [[]]) as $index => $item)
                        ...
                        <div class="card-body">
                            <div class="custom-row gap-3 stock-error d-flex justify-content-between flex-sm-wrape">
                               <div class="w-100 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.dye_lock_type") ? ' has-error' : '' }}">
                                ...
                                {{ html()->select("kt_docs_repeater_advanced[$index][dye_lock_type]", App\Models\DyeLockType::orderBy('type', 'asc')->pluck('type', 'id'), $item->dye_lock_type_id)->class('form-control js-choice')->placeholder('Dye Lock Type') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.length") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][length]", $item->length)->class('form-control')->placeholder('Length') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.width") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][width]", $item->width)->class('form-control')->placeholder('Width') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.height") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][height]", $item->height)->class('form-control')->placeholder('Height') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.tuckin_flap") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][tuckin_flap]", $item->tuckin_flap)->class('form-control')->placeholder('Tuckin Flap') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.pasting_flap") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][pasting_flap]", $item->pasting_flap)->class('form-control')->placeholder('Pasting Flap') }}
                            ...
                            <div class="w-50 m-0 form-group{{ $errors->has("kt_docs_repeater_advanced.$index.ups") ? ' has-error' : '' }}">
                                ...
                                {{ html()->text("kt_docs_repeater_advanced[$index][ups]", $item->ups)->class('form-control')->placeholder('UPS') }}
