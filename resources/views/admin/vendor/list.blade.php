...
<ul id="customContextMenu" class="p-0 dropdown-menu dropdown-menu dropdownmenu-secondary" style="min-width:200pxdisplay:none; position:absolute; z-index: 10000;">
    @can('add_vendor')
        <li>
            <a class="dropdown-item create" model-size="modal-lg" data-title="Add New {{Str::title(str_replace('-', ' ', request()->segment(2)))}}" data-url="{{route('admin.vendor.create')}}" href="javascript:void(0)" id="contextCreate">
    ...
    @can('read_vendor')
        <li>
            <a class="dropdown-item create" bg-color="#f3f3f9" data-title="Import Vendors" data-url="{{route('admin.vendor.import.create')}}" model-size="modal-normal" href="javascript:void(0)" id="contextCreate">
