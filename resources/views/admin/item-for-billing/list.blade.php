...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <a href="javascript:void(0);" bg-color="" model-size="modal-lg" data-ur="{{route('admin.item-for-billing.create')}}" data-title="Create Bill" class="btn btn-sm btn-primary create" id="createPO">Create Bill</a>

            <div class="sm-form-control m-0 form-group{{ $errors->has('filterStatus') ? ' has-error' : '' }}" style="width:120px;">
...
$('body').on('change', '.selectForBilling', function(){
        if($(this).is(':checked')) {
            var id = $(this).val();
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: '{{ route('admin.'.request()->segment(2).'.add-billing')}}',
