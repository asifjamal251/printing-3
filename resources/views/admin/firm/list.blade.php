...
<ul id="customContextMenu" class="p-0 dropdown-menu dropdown-menu dropdownmenu-secondary" style="min-width:200pxdisplay:none; position:absolute; z-index: 10000;">
    @can('add_client')
        <li>
            <a class="dropdown-item create" model-size="modal-lg" data-title="Add New {{Str::title(str_replace('-', ' ', request()->segment(2)))}}" data-url="{{route('admin.firm.create')}}" href="javascript:void(0)" id="contextCreate">
