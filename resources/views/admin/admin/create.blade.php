        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('role', App\Models\Role::whereNotIn('id', [1])->pluck('display_name', 'id'))->class('form-control js-choice')->placeholder('Choose Roll') }}
            ...
            <div class="col-md-4 col-sm-12">
                <div class="form-group{{ $errors->has('enabled_2fa') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('enabled_2fa', App\Models\Status::whereIn('id', [14, 15])->pluck('name', 'id'), 15)->class('form-control js-choice')->id('enabled_2fa')->placeholder('Enabled 2FA') }}
            ...
            <div class="col-md-4 col-sm-12">
                <div class="form-group{{ $errors->has('listing_type') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('listing_type', ['Own' => 'Own', 'All' => 'All'], 'All')->class('form-control js-choice')->placeholder('Listing Type') }}
            ...
            <div class="col-md-4 col-sm-12">
                <div class="form-group{{ $errors->has('stores') ? ' has-error' : '' }}">
                    ...
                    {{ html()->select('stores', App\Models\Store::orderBy('name', 'asc')->pluck('name', 'id'))->class('form-control js-choice')->id('stores')->attribute('multiple')->attribute('data-placeholder', 'Choose Stores') }}
