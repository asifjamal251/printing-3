        ...
        { "data": "slug" },  
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    @can('delete_bread')
                        btn += '<li><button type="button" onclick="deleteModel(\''+window.location.href+'/'+row['slug']+'/delete\')" class="dropdown-item remove-item-btn"><i class="align-bottom ri-delete-bin-fill me-2 text-muted"></i> Delete</button></li>';
                    @endcan
