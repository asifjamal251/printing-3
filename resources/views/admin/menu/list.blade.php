...
@push('links')
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/libs/nestable/jquery.nestable.css') }}" />
@endpush
...
@push('scripts')
<script src="{{asset('assets/admin/libs/nestable/jquery.nestable.js')}}"></script>
